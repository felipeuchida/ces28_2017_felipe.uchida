...
import mvc.model.Model.PersonListener;

@SuppressWarnings("serial")
public class View extends JPanel implements PersonListener, WindowListener{ // observer

	public View(Model person,
			IView personDetailController) {
			...
			this.frame = new JFrame() {
				{
					...
					setContentPane(View.this);
					setDefaultCloseOperation(DISPOSE_ON_CLOSE);
					addWindowListener(View.this);
					pack();
				}
			};
		}
	...
	protected Model getPerson() {
		return _person;
	}

	protected void setPerson(Model person) {
		_person = person;
	}
	...
	private Model _person;
	private IView _controller;
